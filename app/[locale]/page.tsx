...
export async function generateMetadata({ 
  ...
  return {
    ...
    alternates: {
      canonical: `https://bwnxcalculator.com/${locale}`,
      languages: {
        'en': 'https://bwnxcalculator.com/en',
        'th': 'https://bwnxcalculator.com/th',
        'ja': 'https://bwnxcalculator.com/ja',
        'de': 'https://bwnxcalculator.com/de',
        'zh': 'https://bwnxcalculator.com/zh',
        'es': 'https://bwnxcalculator.com/es',
        'pt': 'https://bwnxcalculator.com/pt',
        'fr': 'https://bwnxcalculator.com/fr',
        'ko': 'https://bwnxcalculator.com/ko',
        'ar': 'https://bwnxcalculator.com/ar',
        'hi': 'https://bwnxcalculator.com/hi',
        'id': 'https://bwnxcalculator.com/id',
        'ru': 'https://bwnxcalculator.com/ru',
        'it': 'https://bwnxcalculator.com/it',
        'nl': 'https://bwnxcalculator.com/nl',
        'vi': 'https://bwnxcalculator.com/vi',
        'fa': 'https://bwnxcalculator.com/fa',
      },
    },
  };
}
