...
export async function generateMetadata({ 
  ...
  return {
    ...
    alternates: {
      canonical: `https://bwn-x-web-site1.vercel.app/${locale}`,
      languages: {
        'en': 'https://bwn-x-web-site1.vercel.app/en',
        'th': 'https://bwn-x-web-site1.vercel.app/th',
        'ja': 'https://bwn-x-web-site1.vercel.app/ja',
        'de': 'https://bwn-x-web-site1.vercel.app/de',
        'zh': 'https://bwn-x-web-site1.vercel.app/zh',
        'es': 'https://bwn-x-web-site1.vercel.app/es',
        'pt': 'https://bwn-x-web-site1.vercel.app/pt',
        'fr': 'https://bwn-x-web-site1.vercel.app/fr',
        'ko': 'https://bwn-x-web-site1.vercel.app/ko',
        'ar': 'https://bwn-x-web-site1.vercel.app/ar',
        'hi': 'https://bwn-x-web-site1.vercel.app/hi',
        'id': 'https://bwn-x-web-site1.vercel.app/id',
        'ru': 'https://bwn-x-web-site1.vercel.app/ru',
        'it': 'https://bwn-x-web-site1.vercel.app/it',
        'nl': 'https://bwn-x-web-site1.vercel.app/nl',
        'vi': 'https://bwn-x-web-site1.vercel.app/vi',
        'fa': 'https://bwn-x-web-site1.vercel.app/fa',
      },
    },
  };
}
