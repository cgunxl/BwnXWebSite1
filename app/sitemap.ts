...
function buildUrls(origin: string, basePath: string) {
  ...
  const paths = ['', 'loan', 'mortgage', 'tax', 'insurance', 'vat', 'paycheck', 'currency', 'compound', 'savings-goal', 'credit-card', 'car-loan', 'property-tax', 'inflation', 'roi', 'stock-return', 'dividend', 'tip', 'discount', 'sales-tax', 'crypto-profit', 'bitcoin-mining', 'eth-gas', 'nft-profit', 'sip', 'mutual-fund', 'hourly-wage', 'overtime', 'freelancer-rate', 'privacy', 'terms', 'contact'];
  const urls: string[] = [];
